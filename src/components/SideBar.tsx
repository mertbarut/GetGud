    ...
    >
      ...
      <ul className="relative px-1">
        <li className="relative">
          <a className="flex items-center text-sm py-4 px-6 h-12 overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap rounded hover:text-blue-600 hover:bg-blue-50 transition duration-300 ease-in-out" href={`https://www.github.com/${user.login}`} data-mdb-ripple="true" data-mdb-ripple-color="primary">
