      ...
      >
        ...
        >
          <a>
            ...
            >
              <img
                data-testid={`side-bar-avatar-${user.login === 'Loading...' ? 'default' : user.login}`}
                src={user.avatarUrl}
          ...
          >
            <p
              data-testid={`side-bar-user-fullname-${user.login === 'Loading...' ? 'default' : user.login}`}
              className="pl-4 md:pl-0 text-lg font-semibold text-blue-600"
            >
              {user.name}
            </p>
            <p
              data-testid={`side-bar-user-login-${user.login === 'Loading...' ? 'default' : user.login}`}
        ...
        <p
          data-testid={`side-bar-user-bio-${user.login === 'Loading...' ? 'default' : user.login}`}
          className="text-sm text-center md:text-md font-md text-slate-900 my-4"
        >
          {user.bio}
        </p>
        <p
          data-testid={`side-bar-user-socials-${user.login === 'Loading...' ? 'default' : user.login}`}
      ...
      <hr className="my-2" />
      {
        ...
        <ul className="relative px-1">
          <li className="relative">
            <a
              data-testid={`side-bar-user-github-profile-${user.login === 'Loading...' ? 'default' : user.login}`}
            ...
            >
              ...
              <span>See Profile on GitHub</span>
            </a>
          </li>
        </ul>
      }
