...
import { PageChangeAction, totalRepositoriesChangeAction, DisplayedUserChangeAction, SearchQueryChangeAction } from '../actions'
...
/**
 * Returns a dispatch function that sets the redux state "displayedUser" to
 * the User object given as parameter.
 *
 * @return Dispatch function.
 * @param {User} user User object to update the redux state "displayedUser" with.
 */
